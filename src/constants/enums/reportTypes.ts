...
export type ReportType = typeof REPORT_TYPES_BY_DEPARTMENT[keyof typeof REPORT_TYPES_BY_DEPARTMENT][number];

export const getReportTypesForDepartment = (department: DepartmentType): readonly string[] => {
  return REPORT_TYPES_BY_DEPARTMENT[department] || REPORT_TYPES_BY_DEPARTMENT['Business'];
};
