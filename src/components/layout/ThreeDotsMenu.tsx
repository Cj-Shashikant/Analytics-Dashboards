    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DropdownMenuContent align="end" className="w-56 p-1 bg-white border border-gray-200 rounded-xl shadow-lg">
        ...
        {chartTypes.map((chart) => {
          ...
          const topCount = topFilter ? parseInt(topFilter.replace('Top ', '')) : 0;
          const isDonutBlocked = chart.type === 'donut' && topCount > 15;
          
          return (
            <DropdownMenuItem
              key={chart.type}
              onClick={() => !isDonutBlocked && handleChartTypeSelect(chart.type)}
              ...
              <div className="flex items-center w-full">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className={`text-xs ${
                    ...
                    {isDonutBlocked ? 'Switch to Top 15 or lower to use donut chart' : chart.description}
                  </div>
                </div>
