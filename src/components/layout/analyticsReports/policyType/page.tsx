...
export function ChartsSection({
  ...
  // Get current value unit from Redux state with fallbacks
  ...
  // Get data - PolicyType folder specifically uses revenueByPolicyType data
  const getReportData = () => {
    // PolicyType folder always uses revenueByPolicyType data from Redux
    return revenueState.revenueByPolicyType || [];
  };
