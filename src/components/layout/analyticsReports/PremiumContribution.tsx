...
export function PremiumContribution({
  valueUnit,
  currentFilters,
  onPlayFullView,
}: PremiumContributionProps) {
                      ...
                      return (
                        <div className="bg-white p-3 border border-gray-200 rounded-lg shadow-lg">
                          ...
                          <p className="text-sm text-gray-600">
                            Premium Contribution: {data.contributionPercentage}%
                          </p>
                          <p className="text-sm text-gray-600">
                            Total Premium:{' '}
                            {getFormattedValue(data.totalPremium)}
                          </p>
                          <p className="text-sm text-gray-600">
                            Customer %: {data.percentage}%
                          </p>
                        </div>
                      );
                    }
