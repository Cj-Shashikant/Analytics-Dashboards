...
export const getChartSubtitle = (selectedReportType: string, topFilter: string) => {
...
export const productsListStyles = {
  container: "bg-card text-card-foreground gap-6 rounded-xl border p-2 flex flex-col",
  ...
  table: {
    ...
    headerCellRight: "text-sm font-normal text-gray-700 text-center flex items-center",
