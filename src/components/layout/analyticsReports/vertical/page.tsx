...
export function ChartsSection({
  ...
  // Get data - Vertical folder specifically uses revenueByVertical data
  const getReportData = () => {
    // Vertical folder always uses revenueByVertical data from Redux
    return revenueState.revenueByVertical || [];
  };
