...
export function ChartsSection({
  ...
  // Get data - Cross-cell folder specifically uses crossSellPenetration data
  const getReportData = () => {
    // Cross-cell folder always uses crossSellPenetration data from Redux
    return revenueState.crossSellPenetration || [];
  };
...
export default function CrossCellPage() {
